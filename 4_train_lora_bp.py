#!/usr/bin/env python3
# train_iter.py  -- iteration-based training using BACKPROP + LoRA adapters
...
# ----------- OUTPUT DIRS -----------
base_output_dir = Path("output/lora_bp")
...
# optional: print trainable params count
...
# optimizer & scheduler (only LoRA params are trainable)
